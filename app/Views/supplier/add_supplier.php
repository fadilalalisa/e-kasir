        ...
        <div class="card-body">
            ...
            <form action="/supplier/save" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_supplier" name="id_supplier" value="<?= old('id_supplier'); ?>" autofocus required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control" id="telepon" name="telepon" value="<?= old('telepon') ?>" />
                </div>
